    ...
    public function style(): string {
        if (!static::$rendered) {
            ...
            return <<<CSS
                ...
                #o-footer-accesDirect.o-footer-theme-light {
                background-color:#fff;
                color:#000;
                border-color:#ccc
                }
                #o-footer-accesDirect.o-footer-theme-light ul li a {
                color:#000
                }
                #o-footer-accesDirect.o-footer-theme-light ul li a:visited {
                color:#000
                }
                #o-footer-accesDirect.o-footer-theme-light ul li a:focus {
                color:#000
                }
                #o-footer-accesDirect.o-footer-theme-light ul li a:hover {
                color:#000
                }
                #o-footer-accesDirect.o-footer-theme-light ul li a:active {
                color:#f16e00
                }
                #o-footer-accesDirect.o-footer-theme-light ul li a .o-link-icon:before {
                color:#000
                }
                #o-footer-accesDirect ul {
                margin:0;
                padding:0;
                list-style-type:none;
                ...
                #o-footer-accesDirect ul li {
                float:left;
                margin-right:30px;
                margin-top:20px
                }
                #o-footer-accesDirect ul li:last-child {
                margin-right:0;
                margin-bottom:20px
                }
                #o-footer-accesDirect ul li a {
                color:#fff;
                font-size:16px;
                text-decoration:none;
                display:inline-block;
                ...
                #o-footer-accesDirect ul li a:visited {
                color:#fff
                }
                #o-footer-accesDirect ul li a:focus {
                color:#ccc
                }
                #o-footer-accesDirect ul li a:hover {
                color:#ccc
                }
                #o-footer-accesDirect ul li a:active {
                color:#FF7900
                }
                #o-footer-accesDirect ul li a:focus .o-link-icon:before,
                #o-footer-accesDirect ul li a:hover .o-link-icon:before {
                color:#ccc
                }
                #o-footer-accesDirect ul li a:focus .o-link-text span,
                #o-footer-accesDirect ul li a:hover .o-link-text span {
                text-decoration:underline;
                text-decoration-color:#ccc
                }
                #o-footer-accesDirect ul li a:active .o-link-icon:before {
                color:#FF7900
                }
                #o-footer-accesDirect ul li a:active .o-link-text span {
                text-decoration:underline;
                text-decoration-color:#FF7900
                }
                #o-footer-accesDirect ul li a .o-link-icon {
                float:left
                }
                #o-footer-accesDirect ul li a .o-link-icon:before {
                color:#fff;
                margin-right:15px;
                font-size:30px;
                line-height:1em;
                ...
                #o-footer-accesDirect ul li a .o-link-icon:before,
                #o-footer-accesDirect ul li a .o-link-icon:hover:before {
                text-decoration:none
                }
                #o-footer-accesDirect ul li a .o-link-text,
                #o-footer-accesDirect ul li a .o-link-text span {
                display:inline-block;
                line-height:1.875em;
                font-weight:700
                }
                #o-footer-accesDirect .o-footer-content {
                max-width:1440px
                }
                #o-footer-lienLegal {
                -moz-box-sizing:border-box;
                ...
                #o-footer-lienLegal.o-footer-theme-light a,
                #o-footer-lienLegal.o-footer-theme-light li {
                color:#000
                }
                #o-footer-lienLegal ul {
                margin:0;
                padding:0;
                list-style-type:none;
                list-style-image:none;
                ...
                #o-footer-lienLegal ul li:last-child {
                margin-right:0;
                margin-bottom:20px
                }
                #o-footer-lienLegal ul li a {
                color:#fff;
                text-decoration:none;
                display:inline-block;
                font-size:16px
                }
                #o-footer-lienLegal ul li a:focus span,
                #o-footer-lienLegal ul li a:hover span {
                text-decoration:underline;
                text-decoration-color:#ccc;
                color:#ccc
                }
                #o-footer-lienLegal ul li a:active {
                outline:0
                }
                #o-footer-lienLegal ul li a:active span {
                color:#FF7900;
                text-decoration-color:#FF7900
                }
                #o-footer-lienLegal ul li a .o-link-text,
                #o-footer-lienLegal ul li a .o-link-text span {
                display:inline-block
                }
                ...
                #o-footer-lienLegal-compact[data-show] #o-footer-lienLegal-compact-content {
                display:block
                }
                #o-footer-lienLegal-compact[data-show] .o-footer-lienLegal-compact-btn:after {
                content:'\e645'
                }
                #o-footer-lienLegal-compact.o-footer-theme-light ul {
                border-color:#ccc
                }
                #o-footer-lienLegal-compact.o-footer-theme-light .o-footer-lienLegal-compact-btn {
                background:#fff;
                color:#000;
                border-top:1px solid #ccc
                }
                #o-footer-lienLegal-compact #o-footer-lienLegal-compact-content {
                list-style-type:none;
                list-style-image:none;
                margin:0;
                padding:0;
                ...
                #o-footer-lienLegal-compact #o-footer-lienLegal-compact-content li {
                min-height:40px;
                line-height:40px;
                background-color:#fff
                }
                #o-footer-lienLegal-compact #o-footer-lienLegal-compact-content li a {
                text-decoration:none;
                display:inline-block;
                width:100%;
                ...
                #o-footer-lienLegal-compact #o-footer-lienLegal-compact-content li a:hover {
                background-color:#ddd
                }
                #o-footer-lienLegal-compact #o-footer-lienLegal-compact-content li a .o-link-text {
                color:#000;
                font-weight:700
                }
                #o-footer-lienLegal-compact #o-footer-lienLegal-compact-content li a:focus-visible {
                outline-offset:-1px
                }
                #o-footer-lienLegal-compact .o-footer-lienLegal-compact-btn {
                background:#000;
                color:#fff;
                min-height:40px;
                line-height:40px;
                ...
                #o-footer-lienLegal-compact .o-footer-lienLegal-compact-btn:after {
                content:'\e646';
                font-family:o-icomoon;
                font-size:26px;
                float:right;
                ...
                #o-footer-lienLegal-compact .o-footer-lienLegal-compact-btn:focus-visible {
                outline-offset:-1px
                }
                #o-footer-lienLegal .o-footer-content {
                max-width:1440px
                }
                #o-footer-syndication .o-footer-content a:before {
                color:#fff;
